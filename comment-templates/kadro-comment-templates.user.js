...
(function() {
    ...
    const DEFAULT_TEMPLATES = [
        ...
        },
        {
            ...
            "text": "Добрий день! Запитання потрібно ставити нашому АІ-консультанту (скріпка АІ у правому нижньому куті), або через кнопку ПОСТАВИТИ ЗАПИТАННЯ ☝️ на малюку зверху. Також можете натиснути [тут](https://kadroland.com/chat) і поставити питання у віконці що відкриється"
        },
        {
        ...
        },
        {
            ...
            "text": "Дуже хороше запитання - дякуємо, що задали його! До речі, наш [AI-Консультант 🤖](https://kadroland.com/chat) уже вміє детально пояснювати саме такі ситуації 😉 Ви можете поставити йому запитання у довільній формі, і він дасть точну відповідь за кілька секунд."
        },
        {
            "label": "🤖 Власна думка AI",
            "text": "Наш [AI-Консультант 🤖](https://kadroland.com/chat) вже має на це власну думку 😊 Він щодня вивчає оновлення у нормах і дає поради на основі актуальних документів. Спробуйте - можливо, це саме те рішення, яке ви шукаєте!"
        },
        {
